...
def load_encryption_key():
    ...
    try:
        if os.path.exists(KEY_FILE):
            ...
            initialise_encryption_key()
    except:
        msgbox("Error trying to open key_file")
        enc_passwd = ''

def initialise_encryption_key():
    global enc_passwd
    import uuid
    uid = uuid.uuid4()
    enc_passwd = uid.hex
...
class Wmain(SimpleGladeApp):
    ...
    def createMenu(self):
        ...
        self.popupMenu.mnuReset = menuItem = gtk.ImageMenuItem(_("Restart Console"))
        ...
        self.popupMenu.mnuClear = menuItem = gtk.ImageMenuItem(_("Restart and Clear Console"))
        ...
        self.popupMenuTab.mnuRename = menuItem = gtk.ImageMenuItem(_("Rename Console"))
        menuItem.set_image(gtk.image_new_from_stock(gtk.STOCK_EDIT, gtk.ICON_SIZE_MENU))
        self.popupMenuTab.append(menuItem)
        menuItem.connect("activate", self.on_popupmenu, 'R')
        menuItem.show()

        self.popupMenuTab.mnuReset = menuItem = gtk.ImageMenuItem(_("Restart Console"))
        menuItem.set_image(gtk.image_new_from_stock(gtk.STOCK_NEW, gtk.ICON_SIZE_MENU))
        self.popupMenuTab.append(menuItem)
        menuItem.connect("activate", self.on_popupmenu, 'RS')
        menuItem.show()

        self.popupMenuTab.mnuClear = menuItem = gtk.ImageMenuItem(_("Restart and Clear Console"))
        menuItem.set_image(gtk.image_new_from_stock(gtk.STOCK_CLEAR, gtk.ICON_SIZE_MENU))
        self.popupMenuTab.append(menuItem)
